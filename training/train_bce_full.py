"""
Full fine-tuning — BCE Loss baseline, 50 epochs, unfrozen backbone.
"""
...
CONFIG = {
    ...
    "checkpoint_path":  "checkpoints/model_bce_full.pt",
    "metrics_path":     "checkpoints/metrics_bce_full.json",
}
